...
export default function CommandPalette() {
  ...
  const { commandPaletteOpen, setCommandPaletteOpen, setActiveChatId } = useUIStore()
  ...
  const { data } = useQuery({ queryKey: ['chats'], queryFn: listChats, enabled: commandPaletteOpen })
